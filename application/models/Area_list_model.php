...
class Area_list_model extends CI_Model {
...
//        print_r($data);
//            exit();
        return $this->db->insert('arealist', $data);
    }
    ...
    public function updateForm() {
        ...
        $where['id_areaList']= $this->input->post('id_areaList');
//        echo '<pre>';
//        print_r($data);
//        print_r($where);
//            exit();
        return $this->db->update('arealist', $data, $where);
    }
    ...
    public function loadList() {
        return $res = $this->db->query("SELECT * FROM arealist WHERE  `name`<>''")->result();
    }
