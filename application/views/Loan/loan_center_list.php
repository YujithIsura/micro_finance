                                        ...
                                        foreach ($loan_list as $list) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php $app = $list->approved; 
                                                          if($app=='P'){echo '<small class="label pull-right bg-green">Pending</small>';}  
                                                ?></td>
                                                <form class="form-horizontal" action="<?php echo base_url('Loan/Loan_center_con/manageLoan'); ?>" method="post">
                                                <td class="text-blue text-center">                                        
                                                    <button onclick="setLoading();" type="submit"><i class="fa fa-hand-o-up "></i></button>
