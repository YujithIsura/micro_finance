        ...
        <div class="box">
            ...
            <div class="box-body well">
                ...
                <div class="box box-primary col-sm-10">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal" action="<?php echo base_url('Loan_center_con/pay_repayment'); ?>" method="post">
                        <input type="hidden" class="form-control" name="loan_id" id="loan_id" >
                                ...
                                <tbody>
                                    ...
                                    if (!empty($loan)) {
                                        foreach ($loan as $list_item) {
                                            ?>
                                            <tr>
                                                <td> <?php echo $list_item->loan_serial; ?></td>
                                                <td><?php echo $list_item->release_date ?></td>
                                                <td><?php echo number_format($list_item->principal_amount,2) ?></td>
...
<!--                                                <td class="text-blue text-right">                                        
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-6 control-label">Repayment Amount&nbsp;<span style="color:red;" >*</span></label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="repayment_amount" id="repayment_amount" placeholder="Number OR Decimal Only">
                                        <!--<div class="help-block validation_errors" style="color:red;"><i class="fa fa-times-circle-o fa-fw"></i>  sdff sd fsd fs dfgd</div>-->
                                        <?php // echo form_error('user_name', '<div class="help-block validation_errors" style="color:red;"><i class="fa fa-times-circle-o fa-fw"></i> ', '</div>');  ?>
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-6 control-label">Repayment Method&nbsp;<span style="color:red;" >*</span></label>
                                    <div class="col-sm-6">
                                        <select name="id_borrower"  id="id_borrower" class="form-control selectize" ">
