            ...
            <div class="box-body well">
                ...
                <div class="box box-primary col-sm-10">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url('Loan/Loan_con/submitForm'); ?>" enctype="multipart/form-data" method="post">
                        <input type="hidden" class="form-control" value="<?php echo $loans[0]->loan_id;?>" name="loan_id" id="loan_id" >
                        <div class="box-body">
                            ...
                            <div class="col-sm-10" style="align-content: center;">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="id_loan_product" onchange="getLoanProductDetail()"  id="loan_product_name" class="form-control">
                                            ...
                                            <option <?php if($loans[0]->id_loan_product==$product->id_loan_product){echo 'selected';}?> value="<?php echo $product->id_loan_product; ?>" ><?php echo $product->loan_product_name; ?></option>                                            
                                            <?php }}?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="borrower_id"  id="borrower" class="form-control">
                                            ...
                                            <option <?php if($loans[0]->borrower_id==$borrower->id_borrower){echo 'selected';}?> value="<?php echo $borrower->id_borrower; ?>" ><?php echo $borrower->id_borrower.'/'.$borrower->name; ?></option>                                            
                                            <?php }}?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" readonly="" value="<?php echo $loans[0]->serialNo; ?>" class="form-control required" name="serialNo" id="serialNo" placeholder="">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="disbursed_by" style="width: 385px;"  id="disbursed_by" class="form-control">
                                                        ...
                                                        <option <?php if($loans[0]->disbursed_by=='Cash'){echo 'selected';}?> value="Cash" >Cash </option>
                                                        <option <?php if($loans[0]->disbursed_by=='Cheque'){echo 'selected';}?> value="Cheque" >Cheque </option>
                                                    </select>
                                    ...
                                    <div class="col-sm-10" style="margin-left: -54px;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" value="<?php echo number_format($loans[0]->principle_ammount,2)?>" onblur="setThousendSeparators('principle_ammount');formValidation();" onkeypress="javascript:return isNumber(event)" style="width: 385px;" class="form-control" name="principle_ammount" id="principle_ammount" placeholder="Principal Amount" >
                                    ...
                                    <div class="col-sm-10" style="margin-left: -54px;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" value="<?php echo $loans[0]->release_date?>" style="width: 385px;" class="form-control date-picker" required data-date-format="yyyy-mm-dd" name="release_date" id="release_date" placeholder="" >
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="interest_method" style="width: 385px;"  id="interest_method" class="form-control">
                                                        <option value="" > -Select- </option>
                                                        <option <?php if($loans[0]->interest_method=='Flat Rate'){echo 'selected';}?> value="Flat Rate" >Flat Rate </option>
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="interest_charged" style="width: 385px;"  id="interest_charged" class="form-control">
                                                        <option value="" > -Select- </option>
                                                        <option <?php if($loans[0]->interest_charged=='Include interest normally as per Interest Method'){echo 'selected';}?> value="Include interest normally as per Interest Method" >Include interest normally as per Interest Method</option>
                                                        <option <?php if($loans[0]->interest_charged=='Charge All Interest on the Released Date'){echo 'selected';}?> value="Charge All Interest on the Released Date" >Charge All Interest on the Released Date</option>
                                                        <option <?php if($loans[0]->interest_charged=='Charge All Interest on the First Repayment'){echo 'selected';}?> value="Charge All Interest on the First Repayment" >Charge All Interest on the First Repayment</option>
                                                        <option <?php if($loans[0]->interest_charged=='Charge All Interest on the Last Repayment'){echo 'selected';}?> value="Charge All Interest on the Last Repayment" >Charge All Interest on the Last Repayment</option>
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="radio3  radio-success  radio-inline">
                                                    <input id="interest_type_percentage" name="interest_type" value='percentage' type="radio" <?php if($loans[0]->interest_type=='percentage'){echo 'checked';}?> >
                                                ...
                                                <div class="radio3 radio-success radio-inline">
                                                    <input id="interest_type_fixed" name="interest_type" value='fixed' type="radio" <?php if($loans[0]->interest_type=='fixed'){echo 'checked';}?> >
                                    ...
                                    <div class="col-sm-10" style="margin-left: -54px;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" onblur="formValidation2();" value="<?php echo $loans[0]->loan_interest?>" onkeypress="javascript:return isNumber(event)" style="width: 152px;" class="form-control" name="loan_interest" id="loan_interest" placeholder="%" maxlength="3" >
                                            ...
                                            <div class="col-sm-4">
                                                <select name="interest_period" style="width: 225px;margin-left: -127px;"  id="interest_period" class="form-control">
                                                        <option value="" > -Select- </option>
                                                        <option <?php if($loans[0]->interest_period=='Day'){echo 'selected';}?> value="Day" >Per Day</option>
                                                        <option <?php if($loans[0]->interest_period=='Week'){echo 'selected';}?> value="Week" >Per Week</option>
                                                        <option <?php if($loans[0]->interest_period=='Month'){echo 'selected';}?> value="Month" >Per Month</option>
                                                        <option <?php if($loans[0]->interest_period=='Year'){echo 'selected';}?> value="Year" >Per Year</option>
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <select name="duration_period" style="width: 225px;margin-left: -127px;"  id="duration_period" class="form-control">
                                                        <option value="" > -Select- </option>
                                                        <option <?php if($loans[0]->duration_period=='Days'){echo 'selected';}?> value="Days" >Days </option>
                                                        <option <?php if($loans[0]->duration_period=='Weeks'){echo 'selected';}?> value="Weeks" >Weeks </option>
                                                        <option <?php if($loans[0]->duration_period=='Months'){echo 'selected';}?> value="Months" >Months </option>
                                                        <option <?php if($loans[0]->duration_period=='Years'){echo 'selected';}?> value="Years" >Years </option>
                                                </select>
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="repayment_cycle" style="width: 385px;"  id="repayment_cycle" class="form-control">
                                                        <option value="" > -Select- </option>
                                                        <option <?php if($loans[0]->repayment_cycle=='Daily'){echo 'selected';}?> value="Daily" >Daily </option>
                                                        <option <?php if($loans[0]->repayment_cycle=='Weekly'){echo 'selected';}?> value="Weekly" >Weekly </option>
                                                        <option <?php if($loans[0]->repayment_cycle=='Monthly'){echo 'selected';}?> value="Monthly" >Monthly </option>
                                                    </select>
                                    ...
                                    <div class="col-sm-10" style="margin-left: -54px;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input onblur="formValidation4();" value="<?php echo $loans[0]->no_of_repayment;?>" onkeypress="javascript:return isNumber(event)" id="no_of_repayment" style="width: 152px;height: 34px;;text-align: center;" name="no_of_repayment" min="1" max="200" value='1' type="number" >
                                                </br><span id="ln_repay" style="color:green;" ></span></br>
                                                <span id="loan_repay" style="color:red;" ></span>
                                                <?php echo form_error('no_of_repayment'); ?>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                          ...
                                          <span class="glyphicon glyphicon-plus"></span>
                                            ...
                                            <a href="<?php echo base_url('Loan/Loan_con/downloadFile/G0')?>">download</a>
                                    </div>
                                </div>
                                    </div>
                            </div>
                        ...
                        <div class="box-footer">
                            ...
                            <div class="col-sm-6 btn-toolbar">
                                ...
                                <button type="submit" onclick="selectAll();" value="update" name="update" class="btn bg-purple pull-right btn-flat"><i class="fa fa-pencil-square-o"></i> Update</button>
                            </div>
                            <?php }?>
                        </div><!-- /.box-footer -->
                    </form>
