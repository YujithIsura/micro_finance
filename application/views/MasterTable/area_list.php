        ...
        <div class="box">
            ...
            <div class="box-body well">
                ...
                <div class="box box-primary col-sm-10">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal" action="<?php echo base_url('areaList/submitForm'); ?>" method="post">
                        <input type="hidden" class="form-control" name="id_areaList" id="id_areaList" >
                        ...
                        <div class="box-footer">
                            <div class="col-sm-6 btn-toolbar">
                                ...
                                <button <?php if($this->editper[0]->arealist == 0){echo 'disabled'; }?> type="submit" value="update" name="update" class="btn bg-purple pull-right btn-flat"><i class="fa fa-pencil-square-o"></i> Update</button>
                                
                                <button <?php if($this->saveper[0]->arealist == 0){echo 'disabled'; }?> type="submit" value="submit" name="submit" class="btn btn-info pull-right btn-flat"><i class="fa fa-arrow-circle-up"></i> Submit</button>
                            </div>
                        </div><!-- /.box-footer -->
                    </form>
                </div><!-- /.box -->
                                ...
                                <tbody>
                                    ...
                                    if (!empty($list)) {
                                        foreach ($list as $list_item) {
                                            ?>
                                            <tr>
                                                <td> <?php echo $list_item->id_areaList; ?></td>
