            ...
            <div class="box-body well">
                ...
                <div class="box box-primary col-sm-12">
                    ...
                    <div class="panel-body well" style="/*background-color:#;*/">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                         <a href="<?php echo base_url('LoanProduct/index2'); ?>" style="margin-left: 18px;width: 165px;padding-bottom: 8px;padding-top: 8px;" class="btn btn-block btn-social btn-dropbox">
                            <i class="fa fa-dropbox"></i> Add Loan Product
                          </a>
                                </div>
                        </div>
                        <div class="col-sm-12">
                            <table id="my_data_table" name="Custermer_list_table" class="table table-bordered table-striped table-hover table-responsive ">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($loan_product)) {
                                        foreach ($loan_product as $list) {
                                            ?>
                                            <tr>
                                                <td><?php echo $list->loan_product_name; ?></td>
                                                <td><?php echo $list->disbursed_by; ?></td>
                                                <td><?php echo $list->interest_method; ?></td>
                                                <td><?php $order = $list->repayment_order; 
                                                            $order = explode(',', $order);
                                                            $style = "&nbsp<i class='fa fa-hand-o-right '></i>&nbsp";
                                                            echo $order[0].$style.$order[1].$style.$order[2].$style.$order[3];
                                                ?></td>
                                                <form class="form-horizontal" action="<?php echo base_url('LoanProduct/updateView'); ?>" method="post">
                                                <td class="text-blue text-center">                                        
                                                    <button type="submit"><i class="fa fa-hand-o-up "></i></button>
                                                    <input type="hidden" value="<?php echo $list->id_loan_product ?>" id="loan_product_id" name="loan_product_id">
                                                </td>
                                                </form>
                                            </tr>
                                            <?php
