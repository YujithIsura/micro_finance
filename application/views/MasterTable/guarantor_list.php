            ...
            <div class="box-body well">
                ...
                <div class="box box-primary col-sm-12">
                    ...
                    <div class="panel-body well" style="/*background-color:#;*/">
                        ...
                        <div class="col-sm-12">
                            <table id="my_data_table" name="Guarantor_list_table" class="table table-bordered table-striped table-hover table-responsive ">
                                ...
                                <tbody>
                                    <?php
                                    if (!empty($guarantor)) {
                                        foreach ($guarantor as $list) {
                                            ?>
                                            <tr>
                                                <td><?php echo $list->guarantor_name; ?></td>
                                                <td><?php echo $list->nic; ?></td>
                                                <td><?php echo $list->contact_no1; ?></td>
                                                <td><?php echo $list->area_name;?></td>
                                                <form class="form-horizontal" action="<?php echo base_url('Guarantor_con/updateView'); ?>" method="post">
                                                <td class="text-blue text-center">                                        
                                                    <button type="submit"><i class="fa fa-hand-o-up "></i></button>
                                                    <input type="hidden" value="<?php echo $list->guarantor_id ?>" id="guarantor_id" name="guarantor_id">
                                                </td>
                                                </form>
                                            </tr>
                                            <?php
