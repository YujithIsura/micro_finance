        ...
        <div class="box">
            ...
            <div class="box-body well">
                ...
                <div class="box box-primary col-sm-10">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal" action="<?php echo base_url('Mycompany_controll/submitForm'); ?>" method="post"  enctype="multipart/form-data">

                        <input type="hidden" value="<?php echo $company[0]->id; ?>" name="comID">
                                ...
                                <div id="addressInfo" class="col-sm-12 tab-pane fade in active">
                                    <div class="col-sm-5">
                                        <div class="form-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="company_md_txt" id="company_md_txt" value="<?php echo $company[0]->comName;?>" placeholder="Company Name" onchange="setCompanyName()">
                                            <?php echo form_error('company_md_txt'); ?>                                            
                                        </div>

                                        <div class="form-group-sm">
                                            <label for="legal_md_txt" class="control-label">Legal Name &nbsp;  </label>                                            
                                            <input type="text"  class="form-control" name="legal_md_txt" id="legal_md_txt" value="<?php echo $company[0]->legalName;?>" placeholder="Legal Name">
                                            <?php echo form_error('legal_md_txt'); ?>                                           
                                        </div>

                                        <div class="form-group-sm">
                                            <label for="address_md_txt" class="control-label">Address&nbsp;</label>                                            
                                            <textarea id="address_md_txt" name="address_md_txt" class="form-control"  placeholder="address"  ><?php echo $company[0]->address;?>
                                        ...
                                        <div class="form-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="country_md_txt" id="country_md_txt" value="<?php echo $company[0]->country;?>"placeholder="Country">
                                            <?php echo form_error('country_md_txt'); ?>                                          
                                        </div>

                                         <div class="form-group-sm">
                                            <label for="phone_md_txt" class="control-label">Phone&nbsp;</label>                                            
                                            <input type="text" class="form-control" name="phone_md_txt" id="phone_md_txt" value="<?php echo $company[0]->phone;?>"placeholder="Phone">
                                            <?php echo form_error('phone_md_txt'); ?>                                          
                                        </div>

                                        <div class="form-group-sm">
                                            <label for="fax_md_txt" class="control-label">Fax&nbsp;</label>                                            
                                            <input type="text" class="form-control" name="fax_md_txt" id="fax_md_txt" value="<?php echo $company[0]->fax;?>" placeholder="Fax">
                                            <?php echo form_error('fax_md_txt'); ?>                                          
                                        </div>

                                          <div class="form-group-sm">
                                            <label for="email_md_txt" class="control-label">Email&nbsp;</label>                                            
                                            <input type="text" class="form-control" name="email_md_txt" id="email_md_txt" value="<?php echo $company[0]->email;?>"placeholder="Email">
                                    ...
                                    <div class="col-sm-5 col-sm-offset-1">
                                        ...
                                        <div class="form-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="web_md_txt" id="web_md_txt" value="<?php echo $company[0]->web;?>" placeholder="Web Site">
                                            ...
                                            <label for="currency_md_txt" class="control-label">Currency &nbsp;</label>                                                                                           
                                                <select name="currency_md_txt"  id="currency_md_txt" class="form-control" onchange="addCurrency()">
                                                    ...
                                                    foreach ($currency as $row) {
                                                        ...
                                                        <option value="<?php echo $row->curanSymble; ?>"<?php if ($company[0]->currency == $row->curanSymble){echo 'selected';}?>><?php echo $row->curanSymble; ?></option>                                            
                                        ...
                                        <div class="form-group-sm">
                                            <label for="financial_md_txt" class="control-label">Financial Year From&nbsp;</label>                                            
                                              <select name="financial_md_txt"  id="financial_md_txt" class="form-control">
                                                    <option value="<?php echo $company[0]->month;?>" selected><?php echo $company[0]->month;?></option>
                                        ...
                                        <div class="col-sm-12 col-sm-offset-0 col-xs-10 col-xs-offset-1" style="border:1px solid #E0E0E0;min-height: 145px;"> 
                                         <div id="clear" class="col-sm-offset-3"><img id="defaultimg" src="<?php echo base_url('assets/img/logo/prasath2.jpg'); ?>" height="143px" width="150px"> 
                                         </div>
                                            
                                          
                                            <div id="preview" class="col-sm-offset-3">
                                          ...
                                          <div class="col-sm-5">
                                             ...
                                             <div class="form-group-sm">
                                                <label for="tin_no" class="control-label">TIN No &nbsp;  </label>
                                                    ...
                                                    <input type="text" class="form-control" style="text-align: right" name="tin_no" id="tin_no" value="<?php echo $company[0]->tinNo;?>" placeholder="TIN No">
                                            ...
                                            <div class="form-group-sm">
                                                <label for="vat_no" class="control-label">VAT No &nbsp;  </label>
                                                    ...
                                                    <input type="text" class="form-control" style="text-align: right" name="vat_no" id="vat_no" value="<?php echo $company[0]->vatNo;?>" placeholder="VAT No">
                                                    <?php echo form_error('code'); ?>
                                    ...
                                    <div class="col-sm-5 col-sm-offset-1">
                                            ...
                                            <div class="form-group-sm">
                                                <label for="svat_no" class="control-label">SVAT No&nbsp;</label>
                                                    ...
                                                    <input type="text" class="form-control" style="text-align: right" name="svat_no" id="svat_no" value="<?php echo $company[0]->svatNo;?>" placeholder="SVAT No">
                                            ...
                                            <div class="form-group-sm">
                                                <label for="br_no" class="control-label">BR No &nbsp;</label>                                          
                                                    <input type="text" class="form-control" style="text-align: right" name="br_no" id="br_no" value="<?php echo $company[0]->brNo;?>" placeholder="BR No" onblur="convertDecimalPoint()">
